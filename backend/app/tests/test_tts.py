...
# ⚠️ Qwen3-TTS 测试集(2025-Q3,DISABLED / DEPRECATED)已注释 ⚠️
# 见 docs/Qwen3-TTS_MultiSpeaker_Dialogue_Guide.md。
# 当前版本(回退 Qwen3-TTS)直接 if False 包裹,pytest collection 不会发现任何用例,
# 但保留全部源码(已缩进)供恢复时直接去掉 if False 即可。
